...
ALIEN_ROWS     = 5
#half of alien width
ALIEN_HALF_WIDTH = ALIEN_WIDTH/2
...
#bolt starts y position when ship shoots
BOLT_START_HEIGHT = SHIP_HEIGHT/2 +BOLT_HEIGHT/4
#bolt starts y position when alien shoots
BOLT_START_ALIEN = ALIEN_HEIGHT/2 +BOLT_HEIGHT/2
#posistion at which the bolt goes above the height of the window
BOLT_OFF_SCREEN_TOP = GAME_HEIGHT+ BOLT_HEIGHT/2
#posistion at which the bolt goes below the bottom of the window
BOLT_OFF_SCREEN_BOTTOM=  -BOLT_HEIGHT/2

### SCORE BOARD CONSTANTS ###
#X posistion of the scoreboard
SCOREX = 60
#y position of the score board
SCOREY = GAME_HEIGHT -50
